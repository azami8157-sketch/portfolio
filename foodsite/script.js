...
// لیست نمونه 50 غذا (نمونه 10 غذا با عکس واقعی)
const recipes = [
  {name:"Grilled Chicken Salad", country:"USA", ingredients:["chicken","lettuce","tomato","cucumber","oliveoil"], protein:30, carbs:10, fat:12, calories:250, description:"A healthy salad with grilled chicken and fresh vegetables.", image:"https://images.unsplash.com/photo-1604908177528-8d1091d2e8d5?crop=entropy&cs=tinysrgb&fit=max&h=400&w=400"},
  ...
  {name:"Caprese Salad", country:"Italy", ingredients:["tomato","cheese","basil","oliveoil"], protein:10, carbs:5, fat:12, calories:180, description:"Fresh Italian salad with tomato, mozzarella, and basil.", image:"https://images.unsplash.com/photo-1604908177412-2c62a1d7b091?crop=entropy&cs=tinysrgb&fit=max&h=400&w=400"},
  {name:"Veggie Omelette", country:"France", ingredients:["egg","onion","bellpepper","cheese"], protein:15, carbs:5, fat:10, calories:200, description:"Classic French omelette with vegetables and cheese.", image:"https://images.unsplash.com/photo-1617196030768-0b4e2c6d9e4c?crop=entropy&cs=tinysrgb&fit=max&h=400&w=400"},
  {name:"Lemon Fish", country:"Mediterranean", ingredients:["fish","lemon","oliveoil"], protein:20, carbs:0, fat:8, calories:180, description:"Light Mediterranean fish with lemon and olive oil.", image:"https://images.unsplash.com/photo-1600727967508-5ed4b3d4469b?crop=entropy&cs=tinysrgb&fit=max&h=400&w=400"},
